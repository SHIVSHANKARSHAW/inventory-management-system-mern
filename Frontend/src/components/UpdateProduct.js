...
export default function UpdateProduct() {
  ...
  return (
    <div className='container-fluid p-5 update-product-container'>
      <h1 className='update-product-title'>Enter Product Information</h1>
      ...
      <div className='d-flex justify-content-center col-lg-6 col-md-6'>
        <NavLink to='/products' className='btn btn-secondary me-5 fs-4'>Cancel</NavLink>
        <button type='submit' onClick={handleUpdateClick} className='btn btn-primary fs-4' disabled={loading}>{loading ? 'Updating...' : 'Update'}</button>
      </div>
