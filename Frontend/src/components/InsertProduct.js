  ...
  return (
    <div className='container-fluid p-5'>
      ...
      <div className='d-flex justify-content-center col-lg-6 col-md-6'>
        ...
        <button type='submit' onClick={handleInsertClick} className='btn btn-primary fs-4' disabled={loading}>{loading ? 'Inserting...' : 'Insert'}</button>
      </div>
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)}>
        <Modal.Header closeButton>
          <Modal.Title>Confirm Insert</Modal.Title>
        </Modal.Header>
        <Modal.Body>Are you sure you want to insert this product?</Modal.Body>
        <Modal.Footer>
          <Button variant='secondary' onClick={() => setShowModal(false)}>
            Cancel
          </Button>
          <Button variant='primary' onClick={handleConfirmInsert}>
            Confirm
          </Button>
        </Modal.Footer>
      </Modal>
